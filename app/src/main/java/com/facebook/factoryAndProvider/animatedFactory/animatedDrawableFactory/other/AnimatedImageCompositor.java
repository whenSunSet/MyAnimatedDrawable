...
public class AnimatedImageCompositor {
    ...
    private FrameNeededResult isFrameNeededForRendering(int index) {
        ...
        } else if (disposalMethod == AnimatedDrawableFrameInfo.DisposalMethod.DISPOSE_TO_BACKGROUND) {
    ...
    private boolean isKeyFrame(int index) {
        ...
        if (currFrameInfo.blendOperation == AnimatedDrawableFrameInfo.BlendOperation.NO_BLEND && isFullFrame(currFrameInfo)) {
            return true;
        } else
